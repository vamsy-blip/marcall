...
const COPY: Record<Lang, Record<string, string>> = {
  es: {
    ...
    guidedBody: 'La versión real usa modelos de lenguaje de OpenAI con tus FAQs y servicios reales.',
  ...
  en: {
    ...
    guidedBody: 'The real version uses OpenAI language models with your actual FAQs and services.',
